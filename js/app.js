(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const googlePlayLinks = document.getElementsByClassName("btn-google");
        const appOfferLink = getParameterByName("app_offer_link");
        for (const link of googlePlayLinks) if (appOfferLink) link.href = appOfferLink; else link.href = "https://www.google.com/";
    }));
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const links = document.querySelectorAll(".menu-list .menu-list__item .menu-list__link");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        submit.addEventListener("click", (function(e) {
            ...
            const textarea = document.getElementById("messageTextarea").value;
            if (name !== "" && email !== "" && textarea !== "") {
                console.log(`Name: ${name}, Email: ${email}, Text: ${textarea}`);
